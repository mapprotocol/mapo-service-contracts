module.exports = async (taskArgs, hre) => {
    ...
    let factoryData = safeFactory.interface.encodeFunctionData("setup", [
        multipleAddress,
        taskArgs.threshold,
    ...
    await (
        await safeFactory
            .connect(deployer)
            .createProxyWithNonce("3e5c63644e683549055b9be8653de26e0b4cd36e", factoryData, taskArgs.saltnonce, {
                gasLimit: "20000000",
            })
    ).wait();
